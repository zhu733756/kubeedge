...
const (
	...
	// EnableDefaultTaint is used to determining whether to add the default NoSchedule taint on edge node
	EnableDefaultTaint = "with-edge-taint"
	...
	// Custom download url for KubeEdge tar file and checksum file
	KubeEdgeDownloadURL = "kubeedge-download-url"
